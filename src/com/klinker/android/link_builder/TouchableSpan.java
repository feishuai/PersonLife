...
public class TouchableSpan extends ClickableSpan {
	...
	private int getDefaultColor(Context context) {
		TypedArray array = obtainStyledAttrsFromThemeAttr(context,
				R.attr.linkBuilderStyle, R.styleable.LinkBuilder);
		int color = array.getColor(R.styleable.LinkBuilder_defaultLinkColor,
				Link.DEFAULT_COLOR);
		array.recycle();
	...
	public void updateDrawState(TextPaint ds) {
		...
		ds.bgColor = touched ? adjustAlpha(textColor, link.getHighlightAlpha())
				: Color.TRANSPARENT;
