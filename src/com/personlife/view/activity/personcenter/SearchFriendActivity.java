...
public class SearchFriendActivity extends Activity implements OnClickListener {
			...
			public boolean onEditorAction(TextView v, int actionId,
				...
				case EditorInfo.IME_ACTION_DONE:
					...
					for (int i = 0; i < FriendsUtils.userFriends.size(); i++) {
						String uf = FriendsUtils.userFriends.get(i)
								.getNickname();
						if (uf.contains(temp)) {
					...
					temList.clear();
					temList.addAll(h);
					userAdapter = new UserFriendAdapter(
							SearchFriendActivity.this, temList);
	...
	private void initData() {
		...
		// userAdapter = new UserFriendAdapter(SearchFriendActivity.this,
