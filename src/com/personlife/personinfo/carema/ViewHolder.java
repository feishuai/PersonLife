...
public class ViewHolder implements Holder {
	...
	public View getView(LayoutInflater inflater, ViewGroup parent) {
		...
		ViewGroup contentContainer = (ViewGroup) view
				.findViewById(R.id.view_container);
		contentContainer.setBackgroundColor(parent.getResources().getColor(
				getBackgroundColor()));
			...
			public boolean onKey(View v, int keyCode, KeyEvent event) {
				if (keyListener == null) {
					throw new NullPointerException(
							"keyListener should not be null");
				}
	...
	private void addContent(LayoutInflater inflater, ViewGroup parent,
			ViewGroup container) {
