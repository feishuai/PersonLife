...
public class DialogPlus {
	...
	DialogPlus(DialogPlusBuilder builder) {
		LayoutInflater layoutInflater = LayoutInflater.from(builder
				.getContext());
		...
		rootView = (ViewGroup) layoutInflater.inflate(R.layout.base_container,
				decorView, false);
		...
		initContentView(layoutInflater, builder.getHeaderView(),
				builder.getFooterView(), builder.getAdapter(),
				builder.getContentPadding(), builder.getContentMargin());
	...
	private void initExpandAnimator(Activity activity, int defaultHeight,
			int gravity) {
		...
		view.setOnTouchListener(ExpandTouchListener.newListener(activity,
				absListView, contentContainer, gravity, displayHeight,
				defaultHeight));
	}
	 ...
	 */
	private void initContentView(LayoutInflater inflater, View header,
			View footer, BaseAdapter adapter, int[] padding, int[] margin) {
	 ...
	 */
	private View createView(LayoutInflater inflater, View headerView,
			View footerView, BaseAdapter adapter) {
