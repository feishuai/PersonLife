...
public class DialogPlusBuilder {
	...
	/**
	 * Define if the dialog is cancelable and should be closed when back pressed
	 * or click outside is pressed
	 */
	...
	/**
	 * Set background color for your dialog. If no resource is passed 'white'
	 * will be used
	 */
	...
	/**
	 * Add margins to your outmost view which contains everything. As default
	 * they are 0 are applied
	 */
	public DialogPlusBuilder setOutMostMargin(int left, int top, int right,
			int bottom) {
	...
	/**
	 * Set an item click listener when list or grid holder is chosen. In that
	 * way you can have callbacks when one of your items is clicked
	 */
	 ...
	 * possible click events. You can then identify the view by using its id and
	 * handle the correct behaviour
	 */
	...
	public Animation getInAnimation() {
		int res = (inAnimation == INVALID) ? Utils.getAnimationResource(
				this.gravity, true) : inAnimation;
		return AnimationUtils.loadAnimation(context, res);
	}

	public Animation getOutAnimation() {
		int res = (outAnimation == INVALID) ? Utils.getAnimationResource(
	...
	public FrameLayout.LayoutParams getOutmostLayoutParams() {
		FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(
				ViewGroup.LayoutParams.MATCH_PARENT,
				ViewGroup.LayoutParams.MATCH_PARENT);
		params.setMargins(outMostMargin[0], outMostMargin[1], outMostMargin[2],
				outMostMargin[3]);
		return params;
	}
	...
	public int[] getContentMargin() {
		int minimumMargin = context.getResources().getDimensionPixelSize(
