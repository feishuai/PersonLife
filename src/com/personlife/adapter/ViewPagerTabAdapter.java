...
public class ViewPagerTabAdapter extends FragmentPagerAdapter  {
    ...
    public ViewPagerTabAdapter(FragmentManager fm,CharSequence mTitles[], int mNumbOfTabsumb) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        {
            CircleFriendsFragment tab1 = new CircleFriendsFragment();
            return tab1;
        }
        else             // As we are having 2 tabs if the position is now 0 it must be 1 so we are returning second tab
        {
            CircleAppsFragment tab2 = new CircleAppsFragment();
            return tab2;
        }
