...
public class StarRecomAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.starpict = (ImageView) convertView
					.findViewById(R.id.iv_grid_staricon);
			viewHolder.starname = (TextView) convertView
					.findViewById(R.id.tv_grid_starname);
			viewHolder.counts = (TextView) convertView
					.findViewById(R.id.tv_grid_counts);
